  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      if (boosts >= 30) maxbitrate = 384000;
        ...
        .addField("<a:nitro_logo:833402717950836806> Total Boosts", "<a:nitro_logo:833402717950836806> \`" + message.guild.premiumSubscriptionCount + "\`", true)
        .addField("<a:nitro_logo:857526861454376960> Boost-Level", "<a:nitro_logo:857526861454376960> \`" + boostlevel + "\`", true)
